...
module "kube-hetzner" {
  ...
  network_region = "eu-central" # `eu-central`, `us-east`, or `us-west` change to `us-east` if location is ash
...
#    }
  ...
  initial_k3s_channel = "v1.25"  # Needed for Rancher
  ...
  rancher_hostname = "rancher2.acorn1010.com"
